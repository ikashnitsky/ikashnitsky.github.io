...
Recently a research paper made quite a splash over social media, it claimed that experienced developers are wasting more time fiddling around with LLMs than actually saving time with their help. In this blog post I am going to show you how exactly such things may actually happen =)
