...
<button type="button" class="btn btn-warning" aria-label="Download Ilya Kashnitsky's CV as PDF" toolname="DownloadCV" tooldescription="Downloads the academic CV of Ilya Kashnitsky in PDF format">
<a href="https://ikashnitsky.github.io/x/cv/2024-06-cv-ilya-kashnitsky.pdf" style="color:#fff;"> {{< fa file-lines >}} CV</a>
</button>

<button type="button" class="btn btn-success" aria-label="View Ilya Kashnitsky's ORCID profile">
<a href="https://orcid.org/0000-0003-1835-8687" style="color:#fff;"> {{< fa brands orcid >}} ORCID</a>
</button>

<button type="button" class="btn btn-info" aria-label="View Ilya Kashnitsky's Google Scholar profile">
...
<button class="btn btn-lg btn-secondary" type="button" aria-label="Subscribe for email updates from Ilya Kashnitsky" toolname="Subscribe" tooldescription="Sign up for email notifications when new blog posts are published">
